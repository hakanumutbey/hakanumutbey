import{S as e}from"./index-C9ie1EBw.js";const t="bonesDeclaration",l=`#if NUM_BONE_INFLUENCERS>0
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=c);const C={name:n,shader:c},r="instancesDeclaration",I=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=I);const _={name:r,shader:I},i="clipPlaneVertexDeclaration",x=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=x);const O={name:i,shader:x},a="fogVertexDeclaration",E=`#ifdef FOG
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=L);const b={name:u,shader:L};export{C as a,V as b,O as c,R as d,h as e,W as f,F as g,P as h,_ as i,U as j,b as v};
