import{S as e}from"./index-C9ie1EBw.js";import{s as Y,m as $,d as q,a as j,l as Z}from"./logDepthDeclaration-D_dU0h2h.js";import{h as Q}from"./helperFunctions-Ca4tgP2s.js";import{c as J,f as K,a as ee,b as re}from"./fogFragment-DC56mci9.js";const t="prePassDeclaration",E=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=E);const te={name:t,shader:E},a="oitDeclaration",I=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=I);const ae={name:a,shader:I},i="lightUboDeclaration",D=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=D);const ie={name:i,shader:D},o="ltcHelperFunctions",A=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=A);const oe={name:o,shader:A},f="clusteredLightingFunctions",P=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=P);const fe={name:f,shader:P},n="lightsFragmentFunctions",X=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=X);const ne={name:n,shader:X},s="shadowsFragmentFunctions",R=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=R);const se={name:s,shader:R},l="samplerFragmentDeclaration",_=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=_);const le={name:l,shader:_},d="fresnelFunction",y=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=y);const de={name:d,shader:y},c="reflectionFunction",F=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=F);const ce={name:c,shader:F},v="imageProcessingDeclaration",N=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=N);const ve={name:v,shader:N},u="imageProcessingFunctions",M=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=M);const ue={name:u,shader:M},p="textureRepetitionFunctions",O=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=O);const pe={name:p,shader:O},h="bumpFragmentMainFunctions",b=`#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=b);const he={name:h,shader:b},m="bumpFragmentFunctions",W=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=W);const me={name:m,shader:W},S="bumpFragment",z=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=z);const Se={name:S,shader:z},g="decalFragment",U=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=U);const ge={name:g,shader:U},x="depthPrePass",G=`#ifdef DEPTHPREPASS
#if !defined(PREPASS) && !defined(ORDER_INDEPENDENT_TRANSPARENCY)
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);
#endif
return fragmentOutputs;
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=G);const xe={name:x,shader:G},T="lightFragment",H=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=H);const Te={name:T,shader:H},L="logDepthFragment",V=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=V);const Le={name:L,shader:V},w="oitFragment",k=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=k);const we={name:w,shader:k},C="defaultPixelShader",B=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[C]||(e.ShadersStoreWGSL[C]=B);const Ce=[Y,$,q,te,ae,j,Q,ie,oe,fe,ne,se,le,de,ce,ve,ue,pe,he,me,J,Z,K,ee,Se,ge,xe,Te,Le,re,we];for(const r of Ce)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const Pe={name:C,shader:B};export{Pe as defaultPixelShaderWGSL};
