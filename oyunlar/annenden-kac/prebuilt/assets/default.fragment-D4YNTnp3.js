import{S as e}from"./index-C9ie1EBw.js";import{s as J,m as K,d as ee,a as ie,l as te}from"./logDepthDeclaration-C-_UQA07.js";import{h as oe}from"./helperFunctions-BYyVty4b.js";import{c as re,f as ae,a as ne,b as le}from"./fogFragment-C-KK1iI0.js";const t="decalFragmentDeclaration",A=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=A);const se={name:t,shader:A},o="defaultFragmentDeclaration",P=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=P);const fe={name:o,shader:P},r="prePassDeclaration",R=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=R);const de={name:r,shader:R},a="oitDeclaration",X=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=X);const ce={name:a,shader:X},n="lightFragmentDeclaration",F=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=F);const ve={name:n,shader:F},l="lightUboDeclaration",N=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=M);const ue={name:s,shader:M},f="clusteredLightingFunctions",_=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=_);const pe={name:f,shader:_},d="lightsFragmentFunctions",O=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=O);const me={name:d,shader:O},c="shadowsFragmentFunctions",y=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=y);const ge={name:c,shader:y},v="samplerFragmentDeclaration",b=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=b);const Se={name:v,shader:b},h="fresnelFunction",U=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=U);const Ee={name:h,shader:U},u="reflectionFunction",W=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=W);const Ce={name:u,shader:W},p="imageProcessingDeclaration",H=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=H);const De={name:p,shader:H},m="imageProcessingFunctions",z=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=z);const Te={name:m,shader:z},g="textureRepetitionFunctions",V=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=V);const Le={name:g,shader:V},S="bumpFragmentMainFunctions",G=`#ifndef TEXRD_DEFINED
#define TEXRD(s,uv) texture2D(s,uv)
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=G);const Ie={name:S,shader:G},E="bumpFragmentFunctions",B=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=B);const we={name:E,shader:B},C="bumpFragment",k=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=k);const xe={name:C,shader:k},D="decalFragment",Y=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=Y);const Ae={name:D,shader:Y},T="depthPrePass",$=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=$);const Pe={name:T,shader:$},L="lightFragment",Z=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=Z);const Re={name:L,shader:Z},I="logDepthFragment",q=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=q);const Xe={name:I,shader:q},w="oitFragment",j=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=j);const Fe={name:w,shader:j},x="defaultPixelShader",Q=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[x]||(e.ShadersStore[x]=Q);const Ne=[se,fe,J,K,ee,de,ce,ie,oe,ve,he,ue,pe,me,ge,Se,Ee,Ce,De,Te,Le,Ie,we,re,te,ae,ne,xe,Ae,Pe,Re,Xe,le,Fe];for(const i of Ne)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const be={name:x,shader:Q};export{be as defaultPixelShader};
