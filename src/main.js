...
const games = [
  ...
  },
  {
    ...
    status: "Oynanabilir",
    description: "Rüzgarlı havada gemiyi limana park et.",
    longDescription: "RHGPO'da rüzgar gemiyi sürükler, sen de limandaki park alanına yanaşmaya çalışırsın. Her turda rüzgar sertleşir, enerji azalır ve gemiyi düzgün park etmen gerekir.",
    accent: "sea",
    controls: "Klavye, fare ve dokunmatik",
    achievements: ["İlk limana yanaş", "İlk turu bitir", "Beş turu tamamla"],
    updates: ["Rüzgar sürükleme sistemi eklendi", "Liman park etme hedefleri hazırlandı", "Tur bazlı zorluk ayarı kuruldu"],
    stockBase: 121,
  },
  {
    slug: "siyah-adam",
